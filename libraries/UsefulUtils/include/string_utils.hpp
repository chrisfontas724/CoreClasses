...
inline uint64_t hash(const std::string& str) { return simpleHash(str); }
...
inline std::string stringBetweenDeliminators(const std::string& string, const std::string& first,
